...
silent only
cd ~/projects/intersections
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 intersections.h
badd +18 intersections.cpp
badd +19 main.cpp
badd +7 Makefile
argglobal
silent! argdel *
argadd intersections.h
argadd main.cpp
argadd intersections.cpp
set stal=2
edit intersections.cpp
